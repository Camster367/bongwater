...
"""Verify that starting bongwater with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bongwater with -h for help text")
        ...
        self.log.info("Start bongwater with -version for version information")
