...
static CBlock CreateGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    const CScript genesisOutputScript = CScript() << ParseHex("04537253D85055AFB100F7547B49C7F065C859DC9D800B343250012F4ACCE644DC3BB26BCC1C2413354082F5E6B960E0104F99D890A133E307E22C494DE096E856") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.BIP34Hash = uint256S("e0cd8ddf07d6af38610a54cd4882248cd37597792e26534b02b2c75984d42a03");
        ...
        consensus.defaultAssumeValid = uint256S("0xe0cd8ddf07d6af38610a54cd4882248cd37597792e26534b02b2c75984d42a03"); //1441280
        ...
        genesis = CreateGenesisBlock(1619381335, 873654, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xe0cd8ddf07d6af38610a54cd4882248cd37597792e26534b02b2c75984d42a03"));
        assert(genesis.hashMerkleRoot == uint256S("0x5a35fbd9ecff0a0e881ee3f86bdc0fc0ae14d21a251cee49e3510adc9de0c645"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        //vSeeds.emplace_back("seed-a.bongwater.loshan.co.uk");
        //vSeeds.emplace_back("dnsseed.thrasher.io");
        //vSeeds.emplace_back("dnsseed.bongwatertools.com");
        //vSeeds.emplace_back("dnsseed.bongwaterpool.org");
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0xc76f057dc28b0ca58763542d698b4dd9a21f6582063de59aeffc6082a2925ed0"); //612653
        ...
        genesis = CreateGenesisBlock(1486949366, 980127, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xc76f057dc28b0ca58763542d698b4dd9a21f6582063de59aeffc6082a2925ed0"));
        assert(genesis.hashMerkleRoot == uint256S("0x5a35fbd9ecff0a0e881ee3f86bdc0fc0ae14d21a251cee49e3510adc9de0c645"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        //vSeeds.emplace_back("testnet-seed.bongwatertools.com");
        //vSeeds.emplace_back("seed-b.bongwater.loshan.co.uk");
...
public:
    CRegTestParams() {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x722052f0bfc3615d9a5ea5ff88966a024a63be312aca342a90286d12badcb8c1"));
        assert(genesis.hashMerkleRoot == uint256S("0x5a35fbd9ecff0a0e881ee3f86bdc0fc0ae14d21a251cee49e3510adc9de0c645"));
