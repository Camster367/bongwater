...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s bongwater-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bongwater-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bongwater transaction") + "\n" +
              "  bongwater-tx [options] -create [commands]   " + _("Create hex-encoded bongwater transaction") + "\n" +
              "\n";
